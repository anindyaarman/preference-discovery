...
SESSION_CONFIGS = [
    ...
    dict(
        ...
        num_demo_participants=1,
        app_sequence=['preference_discovery','preference_discovery_G2'],
        endowment=3,
        training_rounds=3,
        submit_delay=15,
        rounds=63,
    ...
    dict(
        ...
        num_demo_participants=1,
        app_sequence=['preference_discovery','preference_discovery_G3'],
        endowment=6,
        training_rounds=3,
        submit_delay=15,
        rounds=33,
    ...
    dict(
        ...
        num_demo_participants=1,
        app_sequence=['preference_discovery','preference_discovery_G4'],
        endowment=6,
        training_rounds=3,
        submit_delay=15,
        rounds=63,
